...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        if (convertView == null) {
            ...
            convertView = infalInflater.inflate(R.layout.drawer_list_childitem, null);
        }
    ...
    public int getChildrenCount(int groupPosition) {
    	if (this._listDataHeader == null) {
            Log.e("Debug", "_listDataHeader is null.");
            return 0;
            ...
            Log.e("Debug", "Value of _listDataHeader at position is null: " + groupPosition);
            return 0;
        } else if (this._listDataChild == null) {
            Log.e("Debug", "_listDataChild is null.");
            return 0;
